...
ALLOWED_HOSTS = [
    ...
    '192.168.1.10',  # ⬅️ SEU IP (Verifique se este é seu IP atual, se precisar)
    'simuladoapp.com.br',
    'www.simuladoapp.com.br',
    '.pythonanywhere.com',
    'lauric-nonparticipating-rhys.ngrok-free.dev', # Para webhooks (pode remover se não usar ngrok)
]
